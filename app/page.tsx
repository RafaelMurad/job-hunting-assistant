        ...
        <Card className="shadow-sm">
          <CardHeader className="bg-white border-b border-slate-200">
            ...
            <CardDescription className="text-slate-600">
              This information will be used to analyze job matches and generate personalized cover letters
            </CardDescription>
          </CardHeader>
          <CardContent className="bg-white pt-6">
            <form onSubmit={handleSave} className="space-y-6">
              ...
              <div>
                <Label htmlFor="summary" className="text-slate-900 font-medium">Professional Summary *</Label>
                <Textarea
                  id="summary"
                  value={user.summary}
              ...
              {/* Work Experience */}
              <div>
                <Label htmlFor="experience" className="text-slate-900 font-medium">Work Experience *</Label>
                <Textarea
                  id="experience"
              ...
              {/* Skills */}
              <div>
                <Label htmlFor="skills" className="text-slate-900 font-medium">Skills *</Label>
                <Textarea
                  id="skills"
                  value={user.skills}
